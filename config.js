...
function cycOverlayTienda(planNombre, prefijo){
  ...
  return '<div style="font-size:12px;color:#ccc;font-weight:800">Incluido en el '+planNombre+'</div>'+
    '<div style="font-size:11px;color:#888;max-width:240px;line-height:1.5">Se contrata en nuestra web, controlyconfianza.cl (no desde esta app). Si ya lo tienes, inicia sesión con tu correo y se desbloquea aquí mismo.</div>'+
